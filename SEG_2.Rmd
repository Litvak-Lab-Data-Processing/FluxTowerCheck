...
file_ids <- c("162RxRaO8GO_Jbl4-Ie1MHliA642ncBaK")  # file ID from google drive 
...
# get limit data 
lims <- read.csv(paste0(basedir, "SegVarLims.csv")) ## HERE 
...
radioButtons("power_dx", "Diagnostic variables:",
             c("panelT_1000x_Avg" = "panelT_1000x_Avg",
               ...
               "battbank_8100_Avg" = "battbank_8100_Avg",
               "panelV_8100_Avg" = "panelV_8100_Avg"))
...
flux1$date <- as.Date.POSIXct(flux1$date_time, format="%Y-%m-%d")
  ...
  # key for plotting multiple biomet in a single category
   simpVar_key <- data.frame("OldVariable"=c("AirTC_Avg", "CNR1TC_Avg", 
                                             ...
                                             "WS_ms_sentry_WVc(1)","WS_ms_sentry_WVc(2)", "WS_ms_sentry_WVc(3)", 
                                             "NetTot_Avg", 
                             ...
                             "CombinedPlotVar"=c(rep("AirTC", 2), rep("RH", 1), rep("rH_hmp", 3), rep("SW", 3), 
                                                 ...
                                                 rep("rawWSentry", 3), "NetTot_Avg", rep("PAR", 2),
                                                 rep("infrared", 3)))
...
output$longmissingTableco2h2o <- renderTable({
  ir_vars2 <- list(
    ...
    "co22_um_m_Avg_IR" = co22_long_na_periods,
...
radioButtons("variable3_3", "Biomet variables:",
             c("Air temperature, hmp (C)" = "RTD_temp_Avg",
               ...
               "Grass Soil Heat Flux 1 (W/m2)" = "shf_grass_1_Avg",
               "Grass Soil Heat Flux 2 (W/m2)" = "shf_grass_2_Avg",
               "Open Soil Heat Flux 1 (W/m2)" = "shf_open_1_Avg",
               "Open Soil Heat Flux 2 (W/m2)" = "shf_open_2_Avg"))
...
renderPlotly({
  soil$depth <- factor(soil$depth, levels = c("2p5", "12p5", "22p5", "37p5", "52p5"))
  # Soil Faceted Plot
